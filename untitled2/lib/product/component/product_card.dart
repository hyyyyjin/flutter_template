...
class ProductCard extends ConsumerWidget {
  ...
  factory ProductCard.fromProductModel({ required ProductModel model, VoidCallback? onSubtract, VoidCallback? onAdd }) {
    return ProductCard(
        id: model.id,
        image: Image.network(
            model.imgUrl,
  ...
  factory ProductCard.fromRestaurantProductModel({ required RestaurantProductModel model, VoidCallback? onSubtract, VoidCallback? onAdd }) {
    return ProductCard(
        id: model.id,
        image: Image.network(
          model.imgUrl,
