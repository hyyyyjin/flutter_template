...
//
//
// enum ScreenState { loading, initDone, receivedCalling, broadcasting }
//
...
//
//   /// broadcast
//   ValueNotifier<Message?> broadcastNotifier = ValueNotifier<Message?>(null);
//
...
//         to: to,
//         message: message,
//         messageType: MType.initial
//     );
//     debugPrint('[socket] broadcastMessage - from: ${sendMsg.from} - to: ${sendMsg.to} - msg: ${sendMsg.message} - type: ${sendMsg.messageType}');
//
//     // 메시지 방송 로직 구현
//     broadcastNotifier.value = sendMsg;
//     // WebSocket을 통해 다른 사용자에게 메시지 전송
//     socketEmit('broadcast', sendMsg.toJson());
//   }
//
//   ///  역할
//   void dispose() {
...
//       super.socketOn('broadcast', (data) {
//         debugPrint('[socket] receive broadcast: ${data}');
//         debugPrint('[socket] receive broadcastMessage: ${data['message']}');
//         String message = data['message'];
//         broadcastNotifier.value = Message.fromJson(data);
//       });
//     }
//   }
//
